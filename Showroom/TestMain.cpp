...
void nhapCung(vector<Showroom*>& danhSachXe) {
	...
	danhSachXe.push_back(new OtoTai("T004", 2007, 300, 3000000, 1000));
	danhSachXe.push_back(new OtoTai("T005", 2005, 400, 3500000, 850));
	cout << endl;
}
...
void nhapThemXe(vector<Showroom*>& danhSachXe) {
	...
	while (luaChon != 0) {
		try {
			do {
				int chon;
				cout << "-----NHAP THEM THONG TIN XE------" << endl;
				...
				case 1: {
					...
					cout << "-------------------" << endl;
					do {
						OtoKhach otokhach = nhapotokhach(danhSachXe);
						danhSachXe.push_back(new OtoKhach(otokhach));
				...
				case 2: {
					...
					cout << "-------------------" << endl;
					do {
						OtoTai ototai = nhapototai(danhSachXe);
						danhSachXe.push_back(new OtoTai(ototai));
						cout << "Them xe thanh cong" << endl;
